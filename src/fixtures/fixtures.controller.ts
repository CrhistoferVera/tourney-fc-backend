...
export class FixturesController {
  ...
  @ApiOperation({
    summary: 'Generar fixture',
    description:
      'Genera el fixture del torneo según su formato — solo ORGANIZADOR o STAFF (HU-15)',
  })
  @ApiParam({ name: 'torneoId', description: 'UUID del torneo' })
  @ApiResponse({
    status: 201,
    description: 'Fixture generado',
    type: [FixturePartidoEntity],
  })
  ...
  @ApiOperation({
    summary: 'Ver fixture del torneo',
    description: 'Retorna todos los partidos agrupados por ronda (HU-23)',
  })
  @ApiParam({ name: 'torneoId', description: 'UUID del torneo' })
  ...
  @ApiOperation({
    ...
    description: 'Retorna los partidos de un equipo específico (HU-19)',
  })
  @ApiParam({ name: 'torneoId', description: 'UUID del torneo' })
