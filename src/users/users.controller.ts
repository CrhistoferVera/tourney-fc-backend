...
export class UsersController {
  ...
  @UseGuards(JwtAuthGuard)
  @Patch('me')
  @ApiOperation({ summary: 'Actualizar perfil propio', description: 'Edita nombre, foto de perfil o zona del usuario autenticado' })
  @ApiResponse({ status: 200, description: 'Perfil actualizado', type: UserEntity })
  ...
  @UseGuards(JwtAuthGuard)
  @Delete('me')
  @ApiOperation({ summary: 'Eliminar cuenta propia', description: 'Elimina permanentemente la cuenta del usuario autenticado' })
  ...
  @UseGuards(JwtAuthGuard)
  @Get(':id')
  @ApiOperation({ summary: 'Ver perfil de otro usuario', description: 'Retorna datos públicos de un usuario por su ID' })
  @ApiParam({ name: 'id', description: 'UUID del usuario', example: '52bcd51e-6d88-4f46-b442-b4e407d58b6a' })
  @ApiResponse({ status: 200, description: 'Perfil del usuario', type: UserEntity })
  @ApiResponse({ status: 401, description: 'Token inválido o expirado' })
