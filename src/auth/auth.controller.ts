...
export class AuthController {
  ...
  @ApiOperation({
    ...
    description: 'Crea una cuenta con correo y contraseña',
  })
  ...
  @ApiResponse({
    status: 400,
    description:
      'Datos inválidos (email mal formado, contraseña débil, campos vacíos)',
  })
  @ApiResponse({
    status: 409,
  ...
  @ApiOperation({
    ...
    description:
      'Autentica al usuario y retorna un token JWT válido por 24 horas',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Envía un código de 6 dígitos al correo registrado, válido por 5 minutos',
  })
  @ApiBody({ type: ForgotPasswordDto })
  @ApiResponse({
    status: 200,
    description: 'Código enviado si el correo está registrado',
  })
