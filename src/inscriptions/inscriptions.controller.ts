...
export class InscriptionsController {
  ...
  @ApiOperation({
    ...
    description:
      'El capitán solicita inscribir su equipo a un torneo en estado EN_INSCRIPCION (HU-13)',
  })
  @ApiParam({ name: 'torneoId', description: 'UUID del torneo' })
  @ApiResponse({
    status: 201,
    description: 'Inscripción solicitada',
    type: InscriptionEntity,
  })
  @ApiResponse({
    status: 400,
    description: 'Torneo no en inscripción o cupo lleno',
  })
  @ApiResponse({
    status: 403,
    description: 'Solo el capitán puede solicitar inscripción',
  })
  create(
  ...
  @ApiOperation({
    ...
    description:
      'Lista todas las inscripciones de un torneo — solo ORGANIZADOR o STAFF (HU-14)',
  })
  @ApiParam({ name: 'torneoId', description: 'UUID del torneo' })
  @ApiResponse({
    status: 200,
  ...
  @Patch(':id/status')
  @ApiOperation({
    summary: 'Aprobar o rechazar inscripción',
    description:
      'Cambia el estado de una inscripción — solo ORGANIZADOR o STAFF (HU-14)',
  })
